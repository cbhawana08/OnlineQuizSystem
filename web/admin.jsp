            ...
            <div class="body" style="background-image: url(resources/images/background.jpg);">
                ...
                <div class="contents">
                    <div class="align">
                        ...
                        <div class="admin" style="width: 200px; height: 70px; padding: 15px; background-color:#9BAEB4; margin: 20px 330px 20px 150px; float: left; border-radius: 10px ;"><b><a style="margin-top: 20px; margin-left: 40px; font-size: 35px;" href="adminnotice.jsp">Notice</a></b></div>
                    </div>
                </div>
